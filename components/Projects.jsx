                ...
                <h1 className={styles.aboutHeading}>Projects</h1>
                    ...
                    <div className="card text-center shadow-2xl flex-1">
                        ...
                        <div className="card-body">
                            ...
                            <p>Front-end based game built with vanilla Javascript, CSS and HTML. It’s hangman with a dark twist, where the user can save a witch from burning by guessing the word correctly! Fully styled with music and sound effects to enhance user experience.</p>
